...
const AddPlantPage = ({ navigation, route }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    coordinates: plantData?.coordinates || { latitude: '', longitude: '' },
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <MapView
         // provider={PROVIDER_DEFAULT}
          provider={null} // or omit it
          mapType="none"
          style={styles.map}
          initialRegion={formData.selectedLocation || DEFAULT_REGION}
        ...
        >
          ...
          <Marker
            coordinate={{
              latitude: markerLat || DEFAULT_MARKER.latitude,
              longitude: markerLng || DEFAULT_MARKER.longitude,
            }}
          />
        </MapView>
