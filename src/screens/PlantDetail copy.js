...
const PlantDetailScreen = ({ route, navigation }) => {
  ...
  const chartConfigCommon = {
    ...
    color: (opacity = BAR_OPACITY.normal) => `rgba(220, 53, 69, ${opacity})`, // Standardized red with controlled opacity
  ...
  const areaChartConfig = {
    ...
    decimalPlaces: 0,
    color: (opacity = BAR_OPACITY.normal) => `rgba(220, 53, 69, ${opacity})`, // Standardized red with controlled opacity
    fillShadowGradient: "#ffe5e8", // Light red fill
...
const getHighlightedChartData = (data, chartType) => {
  ...
  const baseColor = `rgba(220, 53, 69, ${BAR_OPACITY.normal})`; // Standardized red with controlled opacity
  const highlightColor = `rgba(220, 53, 69, ${BAR_OPACITY.highlighted})`; // Same red with highlight opacity
                    ...
                    <BarChart
                      ...
                      getBarColor={(dataPoint, index) => {
                        ...
                        if (selectedBarChartType === 'Month' && selectedBarIndex === index) {
                          return 'rgba(220, 53, 69, 1)'; // Same red with reduced opacity for highlight
                        }
                        return `rgba(220, 53, 69, 1)`; // Standardized red
                      }}
                    />
                  </TouchableOpacity>
                </ScrollView>
                    ...
                    <BarChart
                      ...
                      getBarColor={(dataPoint, index) => {
                        ...
                        if (selectedBarChartType === 'Year' && selectedBarIndex === index) {
                          return '#ff6b6b'; // Lighter red for highlight
                        }
                        return `rgba(220, 53, 69, 1)`; // Standardized red
                      }}
                    />
                    ...
                    <BarChart
                      data={sanitizeBarChartData(getHighlightedChartData({
                        ...
                        datasets: totalChartData?.datasets?.map(dataset => ({
                          ...
                          color: (opacity = 1) => `rgba(220, 53, 69, ${opacity})` // Ensure color is a function
                        })) || []
                      }, 'Total'))}
