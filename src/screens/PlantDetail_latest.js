...
function validateChartData(chartData) {
  ...
  if (!Array.isArray(chartData.labels) || !Array.isArray(chartData.datasets)) return false;
  if (chartData.labels.length === 0) return false;
  for (const dataset of chartData.datasets) {
    if (!Array.isArray(dataset.data) || dataset.data.length !== chartData.labels.length) return false;
    ...
    switch (selectedProductionTab) {
      case 'Day':
        if (dayChartData && validateChartData(dayChartData)) {
                ...
                <LineChart
                  data={{
                    ...
                    datasets: [{
                      ...
                      color: (opacity = 1) => `rgba(0, 135, 90, ${opacity})`,                      strokeWidth: 2
                    }]
                  }}
                  width={cardWidth - 20}                  height={220}                  chartConfig={
                    {
                      ...areaChartConfig,
                      backgroundColor: '#ffffff',
                      backgroundGradientFrom: '#ffffff',
                      ...
                      propsForBackgroundLines: {
                        ...
                        strokeDasharray: "",                        stroke: "#e0e0e0",                        strokeWidth: dayChartData && dayChartData.datasets && dayChartData.datasets[0].data.some(val => val !== null) ? 0.8 : 0                      },
                      color: (opacity = 1) => `rgba(0, 135, 90, ${opacity})`,
                      labelColor: (opacity = 1) => `rgba(0, 0, 0, ${opacity})`,
                      strokeWidth: 2,
                      propsForVerticalLabels: {
                        fontSize: 8,                        fontWeight: '600',                        fill: '#000000',                        rotation: 45,                        y: 5,                      },
                      propsForDots: {
                        r: "5",
                        strokeWidth: "2",
                        stroke: "#fff",
                  ...
                  withVerticalLines={false}                  withHorizontalLabels={true}
                  ...
                  style={{
                    ...
                    paddingVertical: 8,
                    paddingBottom: 0,                    marginBottom: 0,                    position: 'relative',
                    left: 0,                    alignSelf: 'center'                  }}
                  xLabelsOffset={0}
                  yLabelsOffset={5}                  yAxisWidth={40}                  segments={5}
                  hidePointsAtIndex={
                  ...
                  connectNulls={false}                  endWithLastValue={true}
                  withFillShadowGradient={true}                  area
                />
              </View>
              {/* ...existing code... */}
            </>
          ...
          chartToRender = <Text>No valid chart data available</Text>;
        }
        break;
      case 'Month':
                ...
                >
                  ...
                  >
                    <BarChart
                      ...
                      withVerticalLines={false}
                      yAxisWidth={60}
                      onDataPointClick={handleDataPointClick}                      getBarColor={(dataPoint, index) => {…}}
                    />
                  </TouchableOpacity>
                </ScrollView>
              </View>
      ...
      case 'Total':
        ...
        if (totalChartData && validateChartData(totalChartData)) {
          chartToRender = (
            <>
              {/* ...existing code... */}
              <View style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    <BarChart
                      ...
                      chartConfig={{
                        ...totalBarChartConfig,
                        color: (opacity = 1) => `rgba(0, 150, 50, ${opacity})`,                        barPercentage: 0.6,
                        propsForDots: {
                          r: "0",
                          strokeWidth: "0"
                        },
