...
export function PlantsMonthlyPVBarChart({ width, height, selectedMonth }) {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          "https://utlsolarrms.com/api/charts/solar_power_per_plant_logs/monthly/",
          {
            plant_id: 970,
            date_parameter,
            loggerSno: "8CAAB5779579",
          },
          {
            headers: {
        ...
        console.log(" Plans Monthly API SUCCESS ✅", response.data);
